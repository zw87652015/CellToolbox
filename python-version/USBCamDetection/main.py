"""
USB Camera Live Stream - Main Application
This is the main entry point for the USB camera live stream application.
"""

import sys
import os
import tkinter as tk
from usb_camera_live import USBCameraLive
from monitor_utils import get_monitor_info

def main():
    """Main function to start the USB camera live stream application"""
