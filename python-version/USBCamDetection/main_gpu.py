"""
GPU-accelerated USB Camera Live Stream - Main Application
This is the main entry point for the GPU-accelerated USB camera live stream application.
"""

import sys
import os
import tkinter as tk
from usb_camera_live_gpu import USBCameraLiveGPU
from monitor_utils import get_monitor_info

def main():
    """Main function to start the GPU-accelerated USB camera live stream application"""
