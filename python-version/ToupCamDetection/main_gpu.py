"""
GPU-accelerated ToupCam Live Stream - Main Application
This is the main entry point for the GPU-accelerated ToupCam live stream application.
"""

import sys
import os
import tkinter as tk
from toupcam_live_gpu import ToupCameraLiveGPU
from monitor_utils import get_monitor_info

def main():
    """Main function to start the GPU-accelerated ToupCam live stream application"""
