    ...
    public static void main(String[] args) {
        ...
        if (arr.length == 0)
            ...
            if (_cam != null) {
                try {
                    int[] s = _cam.get_Size();
                    int bufsize = mzcam.TDIBWIDTHBYTES(s[0] * 24) * s[1];
