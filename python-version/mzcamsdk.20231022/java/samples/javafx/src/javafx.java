    ...
    private void OnEventImage() {
        if (_cam != null) {
            try {
                ...
                ++_total;
            } catch (mzcam.HRESULTException ex) {
