...
/*
    ...
    We use JNA (https://github.com/java-native-access/jna) to call into the mzcam.dll/so/dylib API, the java class mzcam is a thin wrapper class to the native api.
    So the manual en.html(English) and hans.html(Simplified Chinese) are also applicable for programming with mzcam.java.
    See them in the 'doc' directory:
       (1) en.html, English
       (2) hans.html, Simplified Chinese
*/
public class mzcam implements AutoCloseable {
    ...
    public final static int OPTION_FRONTEND_DEQUE_LENGTH  = 0x31;       /* frontend (raw) frame buffer deque length, range: [2, 1024], default: 4
                                                                        ...
                                                                        */
    public final static int OPTION_FRAME_DEQUE_LENGTH     = 0x31;       /* alias of MZCAM_OPTION_FRONTEND_DEQUE_LENGTH */
    ...
    public static class ModelV2 {
        ...
        public long flag;           /* MZCAM_FLAG_xxx, 64 bits */
        public int maxspeed;        /* number of speed level, same as Mzcam_get_MaxSpeed(), the speed range = [0, maxspeed], closed interval */
    ...
    private interface CLib {
        Pointer Mzcam_Version();
        int Mzcam_EnumV2(Pointer ptr);
        int Mzcam_EnumWithName(Pointer ptr);
        Pointer Mzcam_OpenByIndex(int index);
        void Mzcam_Close(Pointer h);
        int Mzcam_PullImageV3(Pointer h, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Mzcam_WaitImageV3(Pointer h, int nWaitMS, Pointer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Mzcam_PullImageV2(Pointer h, Pointer pImageData, int bits, FrameInfoV2 pInfo);
        int Mzcam_PullStillImageV2(Pointer h, Pointer pImageData, int bits, FrameInfoV2 pInfo);
        int Mzcam_PullImageWithRowPitchV2(Pointer h, Pointer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        int Mzcam_PullStillImageWithRowPitchV2(Pointer h, Pointer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        int Mzcam_Stop(Pointer h);
        int Mzcam_Pause(Pointer h, int bPause);
        int Mzcam_Snap(Pointer h, int nResolutionIndex);
        int Mzcam_SnapN(Pointer h, int nResolutionIndex, int nNumber);
        int Mzcam_SnapR(Pointer h, int nResolutionIndex, int nNumber);
        int Mzcam_Trigger(Pointer h, short nNumber);
        int Mzcam_TriggerSync(Pointer h, int nTimeout, Pointer pImageData, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Mzcam_put_Size(Pointer h, int nWidth, int nHeight);
        int Mzcam_get_Size(Pointer h, IntByReference nWidth, IntByReference nHeight);
        int Mzcam_put_eSize(Pointer h, int nResolutionIndex);
        int Mzcam_get_eSize(Pointer h, IntByReference nResolutionIndex);
        int Mzcam_get_FinalSize(Pointer h, IntByReference nWidth, IntByReference nHeight);
        int Mzcam_get_ResolutionNumber(Pointer h);
        int Mzcam_get_Resolution(Pointer h, int nResolutionIndex, IntByReference pWidth, IntByReference pHeight);
        int Mzcam_get_ResolutionRatio(Pointer h, int nResolutionIndex, IntByReference pNumerator, IntByReference pDenominator);
        int Mzcam_get_Field(Pointer h);
        int Mzcam_get_RawFormat(Pointer h, IntByReference nFourCC, IntByReference bitdepth);
        int Mzcam_put_RealTime(Pointer h, int val);
        int Mzcam_get_RealTime(Pointer h, IntByReference val);
        int Mzcam_Flush(Pointer h);
        int Mzcam_get_Temperature(Pointer h, ShortByReference pTemperature);
        int Mzcam_put_Temperature(Pointer h, short nTemperature);
        int Mzcam_get_Roi(Pointer h, IntByReference pxOffset, IntByReference pyOffset, IntByReference pxWidth, IntByReference pyHeight);
        int Mzcam_put_Roi(Pointer h, int xOffset, int yOffset, int xWidth, int yHeight);
        int Mzcam_get_AutoExpoEnable(Pointer h, IntByReference bAutoExposure);
        int Mzcam_put_AutoExpoEnable(Pointer h, int bAutoExposure);
        int Mzcam_get_AutoExpoTarget(Pointer h, ShortByReference Target);
        int Mzcam_put_AutoExpoTarget(Pointer h, short Target);
        int Mzcam_put_AutoExpoRange(Pointer h, int maxTime, int minTime, short maxGain, short minGain);
        int Mzcam_get_AutoExpoRange(Pointer h, IntByReference maxTime, IntByReference minTime, ShortByReference maxGain, ShortByReference minGain);
        int Mzcam_put_MaxAutoExpoTimeAGain(Pointer h, int maxTime, short maxGain);
        int Mzcam_get_MaxAutoExpoTimeAGain(Pointer h, IntByReference maxTime, ShortByReference maxGain);
        int Mzcam_put_MinAutoExpoTimeAGain(Pointer h, int minTime, short minGain);
        int Mzcam_get_MinAutoExpoTimeAGain(Pointer h, IntByReference minTime, ShortByReference minGain);
        int Mzcam_get_ExpoTime(Pointer h, IntByReference Time)/* in microseconds */;
        int Mzcam_put_ExpoTime(Pointer h, int Time)/* inmicroseconds */;
        int Mzcam_get_ExpTimeRange(Pointer h, IntByReference nMin, IntByReference nMax, IntByReference nDef);
        int Mzcam_get_ExpoAGain(Pointer h, ShortByReference Gain);/* percent, such as 300 */
        int Mzcam_put_ExpoAGain(Pointer h, short Gain);/* percent */
        int Mzcam_get_ExpoAGainRange(Pointer h, ShortByReference nMin, ShortByReference nMax, ShortByReference nDef);
        int Mzcam_put_LevelRange(Pointer h, short[] aLow, short[] aHigh);
        int Mzcam_get_LevelRange(Pointer h, short[] aLow, short[] aHigh);
        int Mzcam_put_LevelRangeV2(Pointer h, short mode, RECT pRoiRect, short[] aLow, short[] aHigh);
        int Mzcam_get_LevelRangeV2(Pointer h, ShortByReference pMode, RECT pRoiRect, short[] aLow, short[] aHigh);
        int Mzcam_put_Hue(Pointer h, int Hue);
        int Mzcam_get_Hue(Pointer h, IntByReference Hue);
        int Mzcam_put_Saturation(Pointer h, int Saturation);
        int Mzcam_get_Saturation(Pointer h, IntByReference Saturation);
        int Mzcam_put_Brightness(Pointer h, int Brightness);
        int Mzcam_get_Brightness(Pointer h, IntByReference Brightness);
        int Mzcam_get_Contrast(Pointer h, IntByReference Contrast);
        int Mzcam_put_Contrast(Pointer h, int Contrast);
        int Mzcam_get_Gamma(Pointer h, IntByReference Gamma);
        int Mzcam_put_Gamma(Pointer h, int Gamma);
        int Mzcam_get_Chrome(Pointer h, IntByReference bChrome);    /* monochromatic mode */
        int Mzcam_put_Chrome(Pointer h, int bChrome);
        int Mzcam_get_VFlip(Pointer h, IntByReference bVFlip);  /* vertical flip */
        int Mzcam_put_VFlip(Pointer h, int bVFlip);
        int Mzcam_get_HFlip(Pointer h, IntByReference bHFlip);
        int Mzcam_put_HFlip(Pointer h, int bHFlip);  /* horizontal flip */
        int Mzcam_get_Negative(Pointer h, IntByReference bNegative);
        int Mzcam_put_Negative(Pointer h, int bNegative);
        int Mzcam_put_Speed(Pointer h, short nSpeed);
        int Mzcam_get_Speed(Pointer h, ShortByReference pSpeed);
        int Mzcam_get_MaxSpeed(Pointer h);/* get the maximum speed, "Frame Speed Level", speed range = [0, max] */
        int Mzcam_get_MaxBitDepth(Pointer h);/* get the max bitdepth of this camera, such as 8, 10, 12, 14, 16 */
        int Mzcam_get_FanMaxSpeed(Pointer h);/* get the maximum fan speed, the fan speed range = [0, max], closed interval */
        int Mzcam_put_HZ(Pointer h, int nHZ);
        int Mzcam_get_HZ(Pointer h, IntByReference nHZ);
        int Mzcam_put_Mode(Pointer h, int bSkip); /* skip or bin */
        int Mzcam_get_Mode(Pointer h, IntByReference bSkip);
        int Mzcam_put_TempTint(Pointer h, int nTemp, int nTint);
        int Mzcam_get_TempTint(Pointer h, IntByReference nTemp, IntByReference nTint);
        int Mzcam_put_WhiteBalanceGain(Pointer h, int[] aGain);
        int Mzcam_get_WhiteBalanceGain(Pointer h, int[] aGain);
        int Mzcam_put_BlackBalance(Pointer h, short[] aSub);
        int Mzcam_get_BlackBalance(Pointer h, short[] aSub);
        int Mzcam_put_AWBAuxRect(Pointer h, RECT pAuxRect);
        int Mzcam_get_AWBAuxRect(Pointer h, RECT pAuxRect);
        int Mzcam_put_AEAuxRect(Pointer h, RECT pAuxRect);
        int Mzcam_get_AEAuxRect(Pointer h, RECT pAuxRect);
        int Mzcam_put_ABBAuxRect(Pointer h, RECT pAuxRect);
        int Mzcam_get_ABBAuxRect(Pointer h, RECT pAuxRect);
        int Mzcam_get_MonoMode(Pointer h);
        int Mzcam_get_StillResolutionNumber(Pointer h);
        int Mzcam_get_StillResolution(Pointer h, int nResolutionIndex, IntByReference pWidth, IntByReference pHeight);
        int Mzcam_get_Revision(Pointer h, ShortByReference pRevision);
        int Mzcam_get_SerialNumber(Pointer h, Pointer sn);
        int Mzcam_get_FwVersion(Pointer h, Pointer fwver);
        int Mzcam_get_HwVersion(Pointer h, Pointer hwver);
        int Mzcam_get_FpgaVersion(Pointer h, Pointer fpgaver);
        int Mzcam_get_ProductionDate(Pointer h, Pointer pdate);
        int Mzcam_get_PixelSize(Pointer h, int nResolutionIndex, FloatByReference x, FloatByReference y);
        int Mzcam_AwbOnce(Pointer h, Pointer funTT, Pointer ctxTT);
        int Mzcam_AwbInit(Pointer h, Pointer funWB, Pointer ctxWB);
        int Mzcam_LevelRangeAuto(Pointer h);
        int Mzcam_AbbOnce(Pointer h, Pointer funBB, Pointer ctxBB);
        int Mzcam_put_LEDState(Pointer h, short iLed, short iState, short iPeriod);
        int Mzcam_write_EEPROM(Pointer h, int addr, Pointer pBuffer, int nBufferLen);
        int Mzcam_read_EEPROM(Pointer h, int addr, Pointer pBuffer, int nBufferLen);      
        int Mzcam_rwc_Flash(Pointer h, int action, int addr, int len, Pointer pData);
        int Mzcam_write_Pipe(Pointer h, int pipeId, Pointer pBuffer, int nBufferLen);
        int Mzcam_read_Pipe(Pointer h, int pipeId, Pointer pBuffer, int nBufferLen);
        int Mzcam_feed_Pipe(Pointer h, int pipeId);
        int Mzcam_write_UART(Pointer h, Pointer pBuffer, int nBufferLen);
        int Mzcam_read_UART(Pointer h, Pointer pBuffer, int nBufferLen);
        int Mzcam_put_Option(Pointer h, int iOption, int iValue);
        int Mzcam_get_Option(Pointer h, int iOption, IntByReference iValue);
        int Mzcam_put_Linear(Pointer h, byte[] v8, short[] v16);
        int Mzcam_put_Curve(Pointer h, byte[] v8, short[] v16);
        int Mzcam_put_ColorMatrix(Pointer h, double[] v);
        int Mzcam_put_InitWBGain(Pointer h, short[] v);
        int Mzcam_get_FrameRate(Pointer h, IntByReference nFrame, IntByReference nTime, IntByReference nTotalFrame);
        int Mzcam_FfcOnce(Pointer h);
        int Mzcam_DfcOnce(Pointer h);
        int Mzcam_IoControl(Pointer h, int ioLineNumber, int eType, int outVal, IntByReference inVal);
        int Mzcam_AAF(Pointer h, int action, int outVal, IntByReference inVal);
        int Mzcam_get_AfParam(Pointer h, AfParam pAfParam);
        
        int Mzcam_TriggerSyncArray(Pointer h, int nTimeout, byte[] pImageData, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Mzcam_PullImageV3Array(Pointer h, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Mzcam_WaitImageV3Array(Pointer h, int nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo);
        int Mzcam_PullImageV2Array(Pointer h, byte[] pImageData, int bits, FrameInfoV2 pInfo);
        int Mzcam_PullStillImageV2Array(Pointer h, byte[] pImageData, int bits, FrameInfoV2 pInfo);
        int Mzcam_PullImageWithRowPitchV2Array(Pointer h, byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        int Mzcam_PullStillImageWithRowPitchV2Array(Pointer h, byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo);
        int Mzcam_write_EEPROMArray(Pointer h, int addr, byte[] pBuffer, int nBufferLen);
        int Mzcam_read_EEPROMArray(Pointer h, int addr, byte[] pBuffer, int nBufferLen);
        int Mzcam_rwc_FlashArray(Pointer h, int action, int addr, int len, byte[] pData);
        int Mzcam_write_PipeArray(Pointer h, int pipeId, byte[] pBuffer, int nBufferLen);
        int Mzcam_read_PipeArray(Pointer h, int pipeId, byte[] pBuffer, int nBufferLen);
        int Mzcam_write_UARTArray(Pointer h, byte[] pBuffer, int nBufferLen);
        int Mzcam_read_UARTArray(Pointer h, byte[] pBuffer, int nBufferLen);
        Pointer Mzcam_get_Model(short idVendor, short idProduct);
        int Mzcam_Gain2TempTint(int[] gain, IntByReference temp, IntByReference tint);
        void Mzcam_TempTint2Gain(int temp, int tint, int[] gain);     
    }

    private interface WinLibrary extends CLib, StdCallLibrary {
        WinLibrary INSTANCE = (WinLibrary)Native.load("mzcam", WinLibrary.class, options_);
        
        interface EVENT_CALLBACK extends StdCallCallback {
            void invoke(int nEvent, Pointer ctxEvent);
        }
        
        Pointer Mzcam_Open(WString camId);
        int Mzcam_Replug(WString camId);
        int Mzcam_StartPullModeWithCallback(Pointer h, EVENT_CALLBACK funEvent, Pointer ctxEvent);
        int Mzcam_StartPullModeWithWndMsg(Pointer h, Pointer hWnd, int nMsg);
        int Mzcam_FfcImport(Pointer h, WString filepath);
        int Mzcam_FfcExport(Pointer h, WString filepath);
        int Mzcam_DfcImport(Pointer h, WString filepath);
        int Mzcam_DfcExport(Pointer h, WString filepath);
        ...
        int Mzcam_Update(WString camId, WString filePath, PROGRESS_CALLBACK funProgress, Pointer ctxProgress);
        int Mzcam_GigeEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug);

        interface HISTOGRAM_CALLBACK extends StdCallCallback {
            void invoke(Pointer aHist, int nFlag, Pointer ctxHistogram);
        }
        int Mzcam_GetHistogramV2(Pointer h, HISTOGRAM_CALLBACK funHistogram, Pointer ctxHistogram);
     }
    
    private interface CLibrary extends CLib, Library {
        CLibrary INSTANCE = (CLibrary)Native.load("mzcam", CLibrary.class, options_);
        
        interface EVENT_CALLBACK extends Callback {
            void invoke(int nEvent, Pointer ctxEvent);
        }
        
        Pointer Mzcam_Open(String camId);
        int Mzcam_Replug(String camId);
        int Mzcam_StartPullModeWithCallback(Pointer h, EVENT_CALLBACK funEvent, Pointer ctxEvent);
        int Mzcam_FfcImport(Pointer h, String filepath);
        int Mzcam_FfcExport(Pointer h, String filepath);
        int Mzcam_DfcImport(Pointer h, String filepath);
        int Mzcam_DfcExport(Pointer h, String filepath);
        
        interface HOTPLUG_CALLBACK extends Callback {
            void invoke(Pointer ctxHotPlug);
        }
        void Mzcam_HotPlug(HOTPLUG_CALLBACK funHotPlug, Pointer ctxHotPlug);

        interface PROGRESS_CALLBACK extends Callback {
            void invoke(int percent, Pointer ctxProgress);
        }
        int Mzcam_Update(String camId, String filePath, PROGRESS_CALLBACK funProgress, Pointer ctxProgress);
        int Mzcam_GigeEnable(HOTPLUG_CALLBACK funHotplug, Pointer ctxHotplug);
    ...
    private final static Map options_ = new HashMap() {
        {
            put(Library.OPTION_FUNCTION_MAPPER, new FunctionMapper() {
                HashMap<String, String> funcmap_ = new HashMap() {
                    {
                        put("Mzcam_TriggerSyncArray", "Mzcam_TriggerSync");
                        put("Mzcam_PullImageV3Array", "Mzcam_PullImageV3");
                        put("Mzcam_WaitImageV3Array", "Mzcam_WaitImageV3");
                        put("Mzcam_PullImageV2Array", "Mzcam_PullImageV2");
                        put("Mzcam_PullStillImageV2Array", "Mzcam_PullStillImageV2");
                        put("Mzcam_PullImageWithRowPitchV2Array", "Mzcam_PullImageWithRowPitchV2");
                        put("Mzcam_PullStillImageWithRowPitchV2Array", "Mzcam_PullStillImageWithRowPitchV2");
                        put("Mzcam_write_EEPROMArray", "Mzcam_write_EEPROM");
                        put("Mzcam_read_EEPROMArray", "Mzcam_read_EEPROM");
                        put("Mzcam_rwc_FlashArray", "Mzcam_rwcFlash");
                        put("Mzcam_write_PipeArray", "Mzcam_write_Pipe");
                        put("Mzcam_read_PipeArray", "Mzcam_read_Pipe");
                        put("Mzcam_write_UARTArray", "Mzcam_write_UART");
                        put("Mzcam_read_UARTArray", "Mzcam_read_UART");
                    }
                };
    ...
    */
    ...
    public static String Version() {
        if (Platform.isWindows())
            return _lib.Mzcam_Version().getWideString(0);
        else
            return _lib.Mzcam_Version().getString(0);
    }
    ...
    */
    public static void HotPlug(IHotplugCallback cb) throws HRESULTException {
        ...
        else
        {
            ...
            ((CLibrary)_lib).Mzcam_HotPlug(_hotplugcallback, new Pointer(0));
        }
    }
    ...
    public static DeviceV2[] EnumV2() {
        ...
        return Ptr2Device(ptr, _lib.Mzcam_EnumV2(ptr));
    }
    
    public static DeviceV2[] EnumWithName() {
        Memory ptr = new Memory(512 * 128);
        return Ptr2Device(ptr, _lib.Mzcam_EnumWithName(ptr));
    }
    ...
    public static void GigeEnable(IHotplugCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Mzcam_GigeEnable(p, new Pointer(id)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "hotplugCallback"));
            errCheck(((CLibrary)_lib).Mzcam_GigeEnable(p, new Pointer(id)));
        }
    }
    ...
    */
    ...
    public static mzcam Open(String camId) {
        ...
        if (Platform.isWindows()) {
            if (camId == null)
                tmphandle = ((WinLibrary)_lib).Mzcam_Open(null);
            else
                tmphandle = ((WinLibrary)_lib).Mzcam_Open(new WString(camId));
        }
        else {
            tmphandle = ((CLibrary)_lib).Mzcam_Open(camId);
        }
        if (tmphandle == null)
            return null;
    ...
    */
    /*
        ...
        etc
    */
    public static mzcam OpenByIndex(int index) {
        Pointer tmphandle = _lib.Mzcam_OpenByIndex(index);
        if (tmphandle == null)
            return null;
        return new mzcam(tmphandle);
    }
    ...
    public int getResolutionNumber() throws HRESULTException {
        return errCheck(_lib.Mzcam_get_ResolutionNumber(_handle));
    }
    
    public int getStillResolutionNumber() throws HRESULTException {
        return errCheck(_lib.Mzcam_get_StillResolutionNumber(_handle));
    }
    ...
    */
    ...
    public String getSerialNumber() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_SerialNumber(_handle, p));
    ...
    public String getFwVersion() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_FwVersion(_handle, p));
        return p.getString(0);
    }
    ...
    public String getHwVersion() throws HRESULTException {
        Memory p = new Memory(16);
        errCheck(_lib.Mzcam_get_HwVersion(_handle, p));
        return p.getString(0);
    }
    ...
    public String getProductionDate() throws HRESULTException {
        Memory p = new Memory(16);
        errCheck(_lib.Mzcam_get_ProductionDate(_handle, p));
        return p.getString(0);
    }
    ...
    public void StartPullModeWithCallback(IEventCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Mzcam_StartPullModeWithCallback(_handle, (WinLibrary.EVENT_CALLBACK)_callback, new Pointer(_objid)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(_callback, new CallbackThreadInitializer(false, false, "eventCallback"));
            errCheck(((CLibrary)_lib).Mzcam_StartPullModeWithCallback(_handle, (CLibrary.EVENT_CALLBACK)_callback, new Pointer(_objid)));
        }
    }

    public void StartPullModeWithWndMsg(Pointer hWnd, int nMsg) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Mzcam_StartPullModeWithWndMsg(_handle, hWnd, nMsg));
        else
            errCheck(HRESULTException.E_NOTIMPL);
    }
    ...
    public void PullImageV2(ByteBuffer pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_PullImageV2(_handle, Native.getDirectBufferPointer(pImageData), bits, pInfo));
    ...
    public void PullImageV2(byte[] pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_PullImageV2Array(_handle, pImageData, bits, pInfo));
    }
    
    public void PullStillImageV2(ByteBuffer pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_PullStillImageV2(_handle, Native.getDirectBufferPointer(pImageData), bits, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullStillImageV2(byte[] pImageData, int bits, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_PullStillImageV2Array(_handle, pImageData, bits, pInfo));
    }
    ...
    */
    public void PullImageV3(ByteBuffer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_PullImageV3(_handle, Native.getDirectBufferPointer(pImageData), bStill, bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullImageV3(byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_PullImageV3Array(_handle, pImageData, bStill, bits, rowPitch, pInfo));
    }
    ...
    public void WaitImageV3(int nWaitMS, ByteBuffer pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_WaitImageV3(_handle, nWaitMS, Native.getDirectBufferPointer(pImageData), bStill, bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void WaitImageV3(int nWaitMS, byte[] pImageData, int bStill, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_WaitImageV3Array(_handle, nWaitMS, pImageData, bStill, bits, rowPitch, pInfo));
    }
    ...
    public void PullImageWithRowPitchV2(ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_PullImageWithRowPitchV2(_handle, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullImageWithRowPitchV2(byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_PullImageWithRowPitchV2Array(_handle, pImageData, bits, rowPitch, pInfo));
    }
    ...
    public void PullStillImageWithRowPitchV2(ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_PullStillImageWithRowPitchV2(_handle, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void PullStillImageWithRowPitchV2(byte[] pImageData, int bits, int rowPitch, FrameInfoV2 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_PullStillImageWithRowPitchV2Array(_handle, pImageData, bits, rowPitch, pInfo));
    }
    
    public void Stop() throws HRESULTException {
        errCheck(_lib.Mzcam_Stop(_handle));
    ...
    public void Pause(boolean bPause) throws HRESULTException {
        errCheck(_lib.Mzcam_Pause(_handle, bPause ? 1 : 0));
    }
    ...
    public void Snap(int nResolutionIndex) throws HRESULTException {
        errCheck(_lib.Mzcam_Snap(_handle, nResolutionIndex));
    }
    ...
    public void SnapN(int nResolutionIndex, int nNumber) throws HRESULTException {
        errCheck(_lib.Mzcam_SnapN(_handle, nResolutionIndex, nNumber));
    }
    ...
    public void SnapR(int nResolutionIndex, int nNumber) throws HRESULTException {
        errCheck(_lib.Mzcam_SnapR(_handle, nResolutionIndex, nNumber));
    }
    ...
    */
    public void Trigger(short nNumber) throws HRESULTException {
        errCheck(_lib.Mzcam_Trigger(_handle, nNumber));
    }
    ...
    */
    public void TriggerSync(int nTimeout, ByteBuffer pImageData, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        if (pImageData.isDirect())
            errCheck(_lib.Mzcam_TriggerSync(_handle, nTimeout, Native.getDirectBufferPointer(pImageData), bits, rowPitch, pInfo));
        else if (pImageData.hasArray())
    ...
    public void TriggerSync(int nTimeout, byte[] pImageData, int bits, int rowPitch, FrameInfoV3 pInfo) throws HRESULTException {
        errCheck(_lib.Mzcam_TriggerSyncArray(_handle, nTimeout, pImageData, bits, rowPitch, pInfo));
    }
    
    public void put_Size(int nWidth, int nHeight) throws HRESULTException {
        errCheck(_lib.Mzcam_put_Size(_handle, nWidth, nHeight));
    }
    ...
    public int[] get_Size() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_Size(_handle, p, q));
    ...
    */
    public void put_eSize(int nResolutionIndex) throws HRESULTException {
        errCheck(_lib.Mzcam_put_eSize(_handle, nResolutionIndex));
    }
    
    public int get_eSize() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Mzcam_get_eSize(_handle, p));
        return p.getValue();
    }
    ...
    */
    public int[] get_FinalSize() throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Mzcam_get_FinalSize(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    public int[] get_Resolution(int nResolutionIndex) throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Mzcam_get_Resolution(_handle, nResolutionIndex, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public float[] get_PixelSize(int nResolutionIndex) throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_PixelSize(_handle, nResolutionIndex, p, q));
    ...
    */
    public int[] get_ResolutionRatio(int nResolutionIndex) throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Mzcam_get_ResolutionRatio(_handle, nResolutionIndex, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public int[] get_RawFormat() throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Mzcam_get_RawFormat(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    ...
    public int[] get_AutoExpoRange() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_AutoExpoRange(_handle, maxTime, minTime, maxGain, minGain));
    ...
    public void put_MaxAutoExpoTimeAGain(int maxTime, short maxGain) throws HRESULTException {
        errCheck(_lib.Mzcam_put_MaxAutoExpoTimeAGain(_handle, maxTime, maxGain));
    }
    
    public int[] get_MaxAutoExpoTimeAGain() throws HRESULTException {
        IntByReference p = new IntByReference();
        ShortByReference q = new ShortByReference();
        errCheck(_lib.Mzcam_get_MaxAutoExpoTimeAGain(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    
    public void put_MinAutoExpoTimeAGain(int minTime, short minGain) throws HRESULTException {
        errCheck(_lib.Mzcam_put_MinAutoExpoTimeAGain(_handle, minTime, minGain));
    }
    
    public int[] get_MinAutoExpoTimeAGain() throws HRESULTException {
        IntByReference p = new IntByReference();
        ShortByReference q = new ShortByReference();
        errCheck(_lib.Mzcam_get_MinAutoExpoTimeAGain(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    public int get_ExpoTime() throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Mzcam_get_ExpoTime(_handle, p));
        return p.getValue();
    }
    
    /* in microseconds */
    public void put_ExpoTime(int Time) throws HRESULTException {
        errCheck(_lib.Mzcam_put_ExpoTime(_handle, Time));
    }
    ...
    public int[] get_ExpTimeRange() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_ExpTimeRange(_handle, p, q, r));
    ...
    public short get_ExpoAGain() throws HRESULTException{
        ShortByReference p = new ShortByReference();
        errCheck(_lib.Mzcam_get_ExpoAGain(_handle, p));
        return p.getValue();
    }
    
    /* percent */
    public void put_ExpoAGain(short Gain) throws HRESULTException {
        errCheck(_lib.Mzcam_put_ExpoAGain(_handle, Gain));
    }
    ...
    public short[] get_ExpoAGainRange() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_ExpoAGainRange(_handle, p, q, r));
    ...
    public void put_LevelRange(short[] aLow, short[] aHigh) throws HRESULTException {
        if (aLow.length != 4 || aHigh.length != 4)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Mzcam_put_LevelRange(_handle, aLow, aHigh));
    }
    
    public void get_LevelRange(short[] aLow, short[] aHigh) throws HRESULTException {
        if (aLow.length != 4 || aHigh.length != 4)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Mzcam_get_LevelRange(_handle, aLow, aHigh));
    }
    ...
    public void put_LevelRangeV2(short mode, int roiX, int roiY, int roiWidth, int roiHeight, short[] aLow, short[] aHigh) throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_put_LevelRangeV2(_handle, mode, rc, aLow, aHigh));
    }
    ...
    public int[] get_LevelRangeV2(short[] aLow, short[] aHigh) throws HRESULTException {
        ...
        RECT rc = new RECT();
        errCheck(_lib.Mzcam_get_LevelRangeV2(_handle, pMode, rc, aLow, aHigh));
    ...
    */
    ...
    public int[] get_TempTint() throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Mzcam_get_TempTint(_handle, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    public void put_WhiteBalanceGain(int[] aGain) throws HRESULTException {
        if (aGain.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Mzcam_put_WhiteBalanceGain(_handle, aGain));
    }
    ...
    public void get_WhiteBalanceGain(int[] aGain) throws HRESULTException {
        if (aGain.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Mzcam_get_WhiteBalanceGain(_handle, aGain));
    }
    ...
    public void put_AWBAuxRect(int X, int Y, int Width, int Height) throws HRESULTException {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        errCheck(_lib.Mzcam_put_AWBAuxRect(_handle, rc));
    }
    
    /* left, top, width, height */
    public int[] get_AWBAuxRect() throws HRESULTException {
        RECT rc = new RECT();
        errCheck(_lib.Mzcam_get_AWBAuxRect(_handle, rc));
    ...
    public void put_AEAuxRect(int X, int Y, int Width, int Height) throws HRESULTException {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        errCheck(_lib.Mzcam_put_AEAuxRect(_handle, rc));
    }
    
    /* left, top, width, height */
    public int[] get_AEAuxRect() throws HRESULTException {
        RECT rc = new RECT();
        errCheck(_lib.Mzcam_get_AEAuxRect(_handle, rc));
        return new int[] { rc.left, rc.top, rc.right - rc.left, rc.bottom - rc.top };
    }
    ...
    public void put_BlackBalance(short[] aSub) throws HRESULTException {
        if (aSub.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        errCheck(_lib.Mzcam_put_BlackBalance(_handle, aSub));
    }
    
    public short[] get_BlackBalance() throws HRESULTException {
        short[] p = new short[3];
        errCheck(_lib.Mzcam_get_BlackBalance(_handle, p));
        return p;
    }
    ...
    public void put_ABBAuxRect(int X, int Y, int Width, int Height) throws HRESULTException {
        ...
        rc.top = Y;
        rc.bottom = Y + Height;
        errCheck(_lib.Mzcam_put_ABBAuxRect(_handle, rc));
    }
    
    /* left, top, width, height */
    public int[] get_ABBAuxRect() throws HRESULTException {
        RECT rc = new RECT();
        errCheck(_lib.Mzcam_get_ABBAuxRect(_handle, rc));
        return new int[] { rc.left, rc.top, rc.right - rc.left, rc.bottom - rc.top };
    }
    ...
    public int[] get_StillResolution(int nResolutionIndex) throws HRESULTException {
        IntByReference p = new IntByReference();
        IntByReference q = new IntByReference();
        errCheck(_lib.Mzcam_get_StillResolution(_handle, nResolutionIndex, p, q));
        return new int[] { p.getValue(), q.getValue() };
    }
    ...
    */
    public void put_LEDState(short iLed, short iState, short iPeriod) throws HRESULTException {
        errCheck(_lib.Mzcam_put_LEDState(_handle, iLed, iState, iPeriod));
    }
    
    public void write_EEPROM(int addr, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            errCheck(_lib.Mzcam_write_EEPROM(_handle, addr, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
    ...
    public void write_EEPROM(int addr, byte[] pBuffer) throws HRESULTException {
        errCheck(_lib.Mzcam_write_EEPROMArray(_handle, addr, pBuffer, pBuffer.length));
    }
    
    public int read_EEPROM(int addr, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Mzcam_read_EEPROM(_handle, addr, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public int read_EEPROM(int addr, byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Mzcam_read_EEPROMArray(_handle, addr, pBuffer, pBuffer.length));
    }
    ...
    */
    public int rwc_Flash(int action, int addr, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Mzcam_rwc_Flash(_handle, action, addr, pBuffer.remaining(), Native.getDirectBufferPointer(pBuffer)));
        else if (pBuffer.hasArray())
    ...
    public int rwc_Flash(int action, int addr, byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Mzcam_rwc_FlashArray(_handle, action, addr, pBuffer.length, pBuffer));
    }

    public void write_Pipe(int pipeId, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            errCheck(_lib.Mzcam_write_Pipe(_handle, pipeId, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public void write_Pipe(int pipeId, byte[] pBuffer) throws HRESULTException {
        errCheck(_lib.Mzcam_write_PipeArray(_handle, pipeId, pBuffer, pBuffer.length));
    }
    
    public int read_Pipe(int pipeId, ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Mzcam_read_Pipe(_handle, pipeId, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public int read_Pipe(int pipeId, byte[] pBuffer) throws HRESULTException {
        return errCheck(_lib.Mzcam_read_PipeArray(_handle, pipeId, pBuffer, pBuffer.length));
    }
    
    public void feed_Pipe(int pipeId) throws HRESULTException {
        errCheck(_lib.Mzcam_feed_Pipe(_handle, pipeId));
    }
    
    public void write_UART(ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            errCheck(_lib.Mzcam_write_UART(_handle, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public void write_UART(byte[] pBuffer) throws HRESULTException {
        errCheck(_lib.Mzcam_write_UARTArray(_handle, pBuffer, pBuffer.length));
    }
    
    public int read_UART(ByteBuffer pBuffer) throws HRESULTException {
        if (pBuffer.isDirect())
            return errCheck(_lib.Mzcam_read_UART(_handle, Native.getDirectBufferPointer(pBuffer), pBuffer.remaining()));
        else if (pBuffer.hasArray())
    ...
    public short get_Temperature() throws HRESULTException {
        ShortByReference p = new ShortByReference();
        errCheck(_lib.Mzcam_get_Temperature(_handle, p));
        return p.getValue();
    }
    ...
    public void put_Temperature(short nTemperature) throws HRESULTException {
        errCheck(_lib.Mzcam_put_Temperature(_handle, nTemperature));
    }
    ...
    public void put_Roi(int xOffset, int yOffset, int xWidth, int yHeight) throws HRESULTException {
        errCheck(_lib.Mzcam_put_Roi(_handle, xOffset, yOffset, xWidth, yHeight));
    }
    ...
    public int[] get_Roi() throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_get_Roi(_handle, p, q, r, s));
    ...
    */
    public int[] get_FrameRate() throws HRESULTException {
        ...
        IntByReference q = new IntByReference();
        IntByReference r = new IntByReference();
        errCheck(_lib.Mzcam_get_FrameRate(_handle, p, q, r));
        return new int[] { p.getValue(), q.getValue(), r.getValue() };
    }
    
    public void LevelRangeAuto() throws HRESULTException {
        errCheck(_lib.Mzcam_LevelRangeAuto(_handle));
    }
    
    /* Auto White Balance "Once", Temp/Tint Mode */
    public void AwbOnce() throws HRESULTException {
        errCheck(_lib.Mzcam_AwbOnce(_handle, null, null));
    }
    ...
    public void AwbInit() throws HRESULTException {
        errCheck(_lib.Mzcam_AwbInit(_handle, null, null));
    }
    
    public void AbbOnce() throws HRESULTException {
        errCheck(_lib.Mzcam_AbbOnce(_handle, null, null));
    }
    ...
    public void FfcOnce() throws HRESULTException {
        errCheck(_lib.Mzcam_FfcOnce(_handle));
    }
    ...
    public void DfcOnce() throws HRESULTException {
        errCheck(_lib.Mzcam_DfcOnce(_handle));
    }
    ...
    public void FfcExport(String filepath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Mzcam_FfcExport(_handle, new WString(filepath)));
        else
            errCheck(((CLibrary)_lib).Mzcam_FfcExport(_handle, filepath));
    }
    
    public void FfcImport(String filepath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Mzcam_FfcImport(_handle, new WString(filepath)));
        else
            errCheck(((CLibrary)_lib).Mzcam_FfcImport(_handle, filepath));
    }
    
    public void DfcExport(String filepath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Mzcam_DfcExport(_handle, new WString(filepath)));
        else
            errCheck(((CLibrary)_lib).Mzcam_DfcExport(_handle, filepath));
    }
    
    public void DfcImport(String filepath) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Mzcam_DfcImport(_handle, new WString(filepath)));
        else
            errCheck(((CLibrary)_lib).Mzcam_DfcImport(_handle, filepath));
    }
    
    public int IoControl(int ioLineNumber, int eType, int outVal) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Mzcam_IoControl(_handle, ioLineNumber, eType, outVal, p));
        return p.getValue();
    }
    
    public int AAF(int action, int outVal) throws HRESULTException {
        IntByReference p = new IntByReference();
        errCheck(_lib.Mzcam_AAF(_handle, action, outVal, p));
        return p.getValue();
    }
    
    public void get_AfParam(AfParam pAfParam) throws HRESULTException {
        errCheck(_lib.Mzcam_get_AfParam(_handle, pAfParam));
    }
    ...
    public void GetHistogram(IHistogramCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Mzcam_GetHistogramV2(_handle, (WinLibrary.HISTOGRAM_CALLBACK)_histogramcallback, new Pointer(_objid)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(_histogramcallback, new CallbackThreadInitializer(false, false, "histogramcallback"));
            errCheck(((CLibrary)_lib).Mzcam_GetHistogramV2(_handle, (CLibrary.HISTOGRAM_CALLBACK)_histogramcallback, new Pointer(_objid)));
        }
    }
    ...
    */
    public static void Replug(String camId) throws HRESULTException {
        if (Platform.isWindows())
            errCheck(((WinLibrary)_lib).Mzcam_Replug(new WString(camId)));
        else
            errCheck(((CLibrary)_lib).Mzcam_Replug(camId));
    }
    ...
    */
    public static void Update(String camId, String filePath, IProgressCallback cb) throws HRESULTException {
        ...
        if (Platform.isWindows()) {
            ...
            errCheck(((WinLibrary)_lib).Mzcam_Update(new WString(camId), new WString(filePath), p, new Pointer(id)));
        }
        else {
            ...
            Native.setCallbackThreadInitializer(p, new CallbackThreadInitializer(false, false, "progressCallback"));
            errCheck(((CLibrary)_lib).Mzcam_Update(camId, filePath, p, new Pointer(id)));
        }
    }

    public static ModelV2 get_Model(short idVendor, short idProduct) {
        Pointer qtr = _lib.Mzcam_get_Model(idVendor, idProduct);
        if (qtr == Pointer.NULL)
            return null;
    ...
    public static int[] Gain2TempTint(int[] gain) throws HRESULTException {
        ...
        errCheck(_lib.Mzcam_Gain2TempTint(gain, temp, tint));
    ...
    public static void TempTint2Gain(int temp, int tint, int[] gain) throws HRESULTException {
        if (gain.length != 3)
            errCheck(HRESULTException.E_INVALIDARG);
        _lib.Mzcam_TempTint2Gain(temp, tint, gain);
    }
}
