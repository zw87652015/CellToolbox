#ifndef __mzcam_dshow_h__
#define __mzcam_dshow_h__
...
typedef void (__stdcall* PIMZCAM_EXPOSURE_CALLBACK)(void* ctxExpo);                                  /* exposure time or gain changed */
...
typedef void (__stdcall* PIMZCAM_PROGRESS)(int percent, void* ctxProgess);
#endif
...
#ifndef __IMZCAM_DEFINED__
#define __IMZCAM_DEFINED__
    /* Both the DirectShow source filter and the output pin(s) support this interface.
        That is to say, you can use QueryInterface on the filter or the pin(s) to get the IMzcam interface.
    */
    // {66B8EAB5-B594-4141-95FC-691A81B445F6}
    DEFINE_GUID(IID_IMzcam, 0x66b8eab5, 0xb594, 0x4141, 0x95, 0xfc, 0x69, 0x1a, 0x81, 0xb4, 0x45, 0xf6);

    DECLARE_INTERFACE_(IMzcam, IUnknown)
    {
        /*
        ...
        */
        ...
        STDMETHOD(GetHistogram) (THIS_ PIMZCAM_HISTOGRAM_CALLBACK funHistogram, void* ctxHistogram) PURE;
        STDMETHOD(put_ExpoCallback) (THIS_ PIMZCAM_EXPOSURE_CALLBACK funExpo, void* ctxExpo) PURE;
        ...
        */
        ...
        STDMETHOD(AwbInit) (THIS_ PIMZCAM_WHITEBALANCE_CALLBACK funWB, void* ctxWB) PURE;
        ...
        */
        ...
        STDMETHOD(put_ChromeCallback) (THIS_ PIMZCAM_CHROME_CALLBACK funChrome, void* ctxChrome) PURE;
        ...
        STDMETHOD(AwbOnce) (THIS_ PIMZCAM_TEMPTINT_CALLBACK funTT, void* ctxTT) PURE; /* Auto White Balance, Temp/Tint Mode */
        ...
        */
        ...
        STDMETHOD(AbbOnce) (THIS_ PIMZCAM_BLACKBALANCE_CALLBACK funBB, void* ctxBB) PURE;
        ...
        */
        ...
        STDMETHOD(get_FfcStatus) (THIS_ int* status) PURE; /* see MZCAM_OPTION_FFC */
        ...
        STDMETHOD(get_DfcStatus) (THIS_ int* status) PURE; /* see MZCAM_OPTION_DFC */
        ...
        */
        ...
        STDMETHOD(get_AfParam) (THIS_ MzcamAfParam* pAfParam) PURE;
        ...
        */
        ...
        STDMETHOD(get_Flag)(THIS_ unsigned long long* pFlag) PURE; /* model property: MZCAM_FLAG_xxxx */
...
#ifndef __IMZCAMSTILLIMAGE_DEFINED__
#define __IMZCAMSTILLIMAGE_DEFINED__
    ...
    */
    ...
    DEFINE_GUID(IID_IMzcamStillImage, 0xe978eea0, 0xa0ff, 0x465f, 0xab, 0x35, 0x65, 0x90, 0x7b, 0x8c, 0x62, 0xac);
    
    DECLARE_INTERFACE_(IMzcamStillImage, IUnknown)
    {
        /*
...
#ifndef __IMZCAMSERIALNUMBER_DEFINED__
#define __IMZCAMSERIALNUMBER_DEFINED__
    // {E12D4B13-333F-4eae-BC89-0446D1FC634D}
    DEFINE_GUID(IID_IMzcamSerialNumber, 0xe12d4b13, 0x333f, 0x4eae, 0xbc, 0x89, 0x4, 0x46, 0xd1, 0xfc, 0x63, 0x4d);
    
    DECLARE_INTERFACE_(IMzcamSerialNumber, IUnknown)
    {
...
#ifndef __IMZCAMVERSION_DEFINED__
#define __IMZCAMVERSION_DEFINED__

    // {FC69B0C7-6140-4FE7-B385-473E5EA87887}
    DEFINE_GUID(IID_IMzcamVersion, 0xfc69b0c7, 0x6140, 0x4fe7, 0xb3, 0x85, 0x47, 0x3e, 0x5e, 0xa8, 0x78, 0x87);
    
    DECLARE_INTERFACE_(IMzcamVersion, IUnknown)
    {
...
#ifndef __IMZCAMADVANCED_DEFINED__
#define __IMZCAMADVANCED_DEFINED__

    // {88822AD8-3FF5-4252-B615-520925E4FF3B}
    DEFINE_GUID(IID_IMzcamAdvanced, 0x88822ad8, 0x3ff5, 0x4252, 0xb6, 0x15, 0x52, 0x9, 0x25, 0xe4, 0xff, 0x3b);
    
    DECLARE_INTERFACE_(IMzcamAdvanced, IUnknown)
    {
        /* see MZCAM_FRAMEINFO_FLAG_TIMESTAMP */
        STDMETHOD(get_UseCameraTimestamp) (THIS_ int* bUse) PURE;
        STDMETHOD(put_UseCameraTimestamp) (THIS_ int bUse) PURE;
    };
#endif

#ifndef __IMZCAMST4_DEFINED__
#define __IMZCAMST4_DEFINED__

    /* Please see: ASCOM Platform Help ICameraV2 */
    // {29867037-78A9-432F-BF33-A3CFE0D6C9B3}
    DEFINE_GUID(IID_IMzcamST4, 0x29867037, 0x78a9, 0x432f, 0xbf, 0x33, 0xa3, 0xcf, 0xe0, 0xd6, 0xc9, 0xb3);
    
    DECLARE_INTERFACE_(IMzcamST4, IUnknown)
    {
...
static void InitAx(const wchar_t* clsid)
{
    ...
    if (ERROR_SUCCESS == RegOpenKeyExW(HKEY_CLASSES_ROOT, regPath, 0, KEY_READ, &hKey))
    {
        ...
        if (ERROR_SUCCESS == RegQueryValueExW(hKey, NULL, NULL, NULL, (PBYTE)axPath, &cbData)) /* query the full path of mzcam.ax */
        {
...
void InitAxMicro()
{
    /* {EA6387A5-60C7-41D3-B058-8D90580A7BE1} is the clsid of mzcam micro dshow object */
    InitAx(L"{EA6387A5-60C7-41D3-B058-8D90580A7BE1}");
}

void InitAxAstro()
{
    /* {B2190DBF-21E3-4580-98B2-0DB1E557A027} is the clsid of mzcam astro dshow object */
