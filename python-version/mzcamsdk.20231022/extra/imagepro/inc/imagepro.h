...
IMAGEPRO_API(HRESULT) imagepro_stitch_pull(HImageproStitch handle, HMzcam h, int bFeed, void* pImageData, int bits, int rowPitch, MzcamFrameInfoV2* pInfo);
IMAGEPRO_API(HRESULT) imagepro_stitch_pullV3(HImageproStitch handle, HMzcam h, int bFeed, void* pImageData, int bits, int rowPitch, MzcamFrameInfoV3* pInfo);
#endif
...
IMAGEPRO_API(HRESULT) imagepro_edf_pull(HImageproEdf handle, HMzcam h, int bFeed, void* pImageData, int bits, int rowPitch, MzcamFrameInfoV2* pInfo);
IMAGEPRO_API(HRESULT) imagepro_edf_pullV3(HImageproEdf handle, HMzcam h, int bFeed, void* pImageData, int bits, int rowPitch, MzcamFrameInfoV3* pInfo);
#endif
